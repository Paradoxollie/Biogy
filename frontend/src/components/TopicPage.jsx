...
function TopicPage() {
  ...
  const categories = {
    ...
    actualite: { name: 'Actualités', color: 'amber-700' },
    autre: { name: 'Autre', color: 'gray-600' }
  };
      ...
      <div className="container mx-auto px-4 py-12 text-center">
        <div className="bg-red-50 p-8 rounded-lg shadow-md sketch-container">
          ...
          <button
            ...
            className="px-4 py-2 bg-biogy-700 hover:bg-biogy-800 text-white rounded-lg shadow-md hover:shadow-lg  transition-all duration-300"
          >
            Retour au forum
          </button>
        </div>
    ...
    return (
      <div className="container mx-auto px-4 py-12 text-center">
        <div className="bg-amber-50 p-8 rounded-lg shadow-md sketch-container">
          ...
          <button
            onClick={() => navigate('/forum')}
            className="px-4 py-2 bg-gradient-to-r from-amber-500 to-amber-400 text-white rounded-lg shadow-md hover:shadow-lg  transition-all duration-300"
          >
            Retour au forum
          </button>
        </div>
    ...
    <div className="container mx-auto px-4 py-8">
          ...
          >
                ...
                <div className="mb-4 relative">
                  ...
                  <div className="flex justify-end mt-3 space-x-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1 bg-biogy-700 hover:bg-biogy-800 text-white rounded hover:opacity-90 transition-all duration-200 disabled:opacity-50"
                    >
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 border-t border-gray-200 flex justify-between items-center">
              <div className="flex items-center space-x-4">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mr-1.5 ${discussion.likes?.includes(userInfo?._id) ? '' : ''}`} viewBox="0 0 20 20" fill="currentColor">
      ...
      {userInfo ? (
          ...
          <form onSubmit={handleSubmitReply}>
            ...
            {imagePreview.length > 0 && (
              <div className="mb-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2">
                {imagePreview.map((image, index) => (
                  <div key={index} className="relative group transform transition-transform duration-200 ">
                    <img
                      src={image.url}
                      alt={`Aperçu ${index + 1}`}
            ...
            <div className="flex justify-end">
              <button
                ...
                className="px-4 py-2 bg-biogy-700 hover:bg-biogy-800 text-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed transform hover:-translate-y-0.5"
              >
                {submitting ? (
                  <span className="flex items-center">
                    <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div className="bg-gray-50 rounded-lg p-6 text-center sketch-container">
          ...
          <Link
            to="/login"
            className="px-4 py-2 bg-biogy-700 hover:bg-biogy-800 text-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 inline-flex items-center"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
