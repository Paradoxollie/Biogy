  ...
  useEffect(() => {
    if (profile && profile.user && profile.user._id) {
      try {
        ...
        const storedAvatar = storedAvatars[profile.user._id];
        if (storedAvatar) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden sketch-container mb-6">
        <div className="bg-biogy-700 hover:bg-biogy-800 h-32 relative">
          {/* Avatar */}
          <div className="absolute -bottom-16 left-8">
            <div className="w-32 h-32 rounded-full bg-white p-1 shadow-lg">
              {/* Utiliser l'avatar du serveur, l'avatar local, ou l'avatar par défaut */}
