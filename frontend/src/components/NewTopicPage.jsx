...
function NewTopicPage() {
  ...
  if (!userInfo) {
    return <Navigate to="/login?redirect=%2Fforum%2Fnouveau" replace />;
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        <div className="flex items-center mb-2">
          <Link to="/forum" className="text-biogy-700 hover:underline flex items-center">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end space-x-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2 bg-biogy-700 hover:bg-biogy-800 text-white rounded-lg shadow-md hover:shadow-soft transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
