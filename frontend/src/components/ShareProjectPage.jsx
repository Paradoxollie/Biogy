...
function ShareProjectPage() {
  ...
  if (!userInfo || !userInfo.token) {
    return (
      <div className="container mx-auto max-w-3xl p-6 md:p-10 my-10 bg-gradient-to-br from-yellow-50/50 via-amber-50/50 to-orange-50/50 rounded-xl shadow-soft border-t-4 border-amber-600 relative overflow-hidden text-lg">
