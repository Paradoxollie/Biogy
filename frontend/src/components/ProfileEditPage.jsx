        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <div className="flex items-center">
                <input
                  ...
                  onChange={handleChange}
                  className="h-4 w-4 text-biogy-700 focus:ring-lab-purple border-gray-300 rounded"
                />
          ...
          <div className="flex justify-end space-x-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="px-4 py-2 bg-biogy-700 text-white rounded-lg hover:bg-biogy-700/90 transition-all duration-300 disabled:opacity-50"
            >
