...
const RevisionPage = lazy(() => import('./components/RevisionPage'));
...
const MyCopiesPage = React.lazy(() => import('./components/MyCopiesPage'));
      ...
      <Layout>
        <Suspense fallback={<RouteFallback />}>
          <Routes>
            ...
            <Route path="/mes-copies" element={<MyCopiesPage />} />
