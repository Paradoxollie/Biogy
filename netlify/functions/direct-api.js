// Netlify Function pour appel direct à l'API
...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    const path = event.path.replace('/.netlify/functions/direct-api', '');
    ...
    console.log(`Direct API request to: ${fullUrl}`);
