...
// Flux RSS pour la catégorie rouge (actualités)
const RED_FEEDS = [
...
exports.handler = async (event) => {
  ...
  try {
    ...
    const promises = RED_FEEDS.map(feed => fetchRSS(feed));
    ...
    console.error('Erreur lors du traitement des articles rouges:', error);
    return {
      statusCode: 500,
