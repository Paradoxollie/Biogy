...
// Flux RSS pour la catégorie bleue (technologie et innovation)
const BLUE_FEEDS = [
...
exports.handler = async (event) => {
  ...
  try {
    ...
    const promises = BLUE_FEEDS.map(feed => fetchRSS(feed));
    ...
    console.error('Erreur lors du traitement des articles bleus:', error);
    return {
      statusCode: 500,
